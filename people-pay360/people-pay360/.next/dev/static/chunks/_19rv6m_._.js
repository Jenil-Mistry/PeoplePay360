...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$a2cd19__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/actions/data:a2cd19 [app-client] (ecmascript) <text/javascript>");
;
...
function SignInPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$a2cd19__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["signInUser"])({
                email,
                password
            });
            if (result.error) {
...
"[project]/lib/actions/data:a2cd19 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_19rv6m_._.js.map